            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center py-4 flex-wrap gap-4">
                    ...
                    <div class="flex items-center gap-2 text-sm">
                        ...
                        >
                            <Icon icon="material-symbols:home-outline" width="20" height="20" class="group-hover:scale-110 transition-transform duration-200" />
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
                    ...
                    <div class="bg-[var(--ui-bg)] border border-[var(--ui-border)] rounded-xl shadow-sm overflow-hidden">
                        <div class="p-6 sm:p-8">
                            ...
                            <div class="prose prose-sm prose-zinc max-w-none">
                                <MdPreview :modelValue="content" class="break-words max-w-none" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="lg:col-span-1">
                    <div class="space-y-6">
                        <!-- 빠른 액션 카드 -->
                        <div class="bg-[var(--ui-bg)] border border-[var(--ui-border)] rounded-xl shadow-sm p-6 sticky top-24">
                            ...
                            <div class="space-y-3">
                                ...
                                >
                                    <div class="w-8 h-8 bg-[var(--ui-primary)]/10 rounded-lg flex items-center justify-center">
                                        <Icon icon="material-symbols:edit" width="16" height="16" class="text-[var(--ui-primary)]" />
                                    </div>
                                    <div class="flex-1 text-left">
                                        <div class="text-sm font-medium">편집하기</div>
                                        <div class="text-xs text-[var(--ui-text-muted)]">이 문서를 수정합니다</div>
                                    </div>
                                    <Icon icon="material-symbols:chevron-right" width="16" height="16" class="text-[var(--ui-text-muted)] group-hover:translate-x-1 transition-transform duration-200" />
                                </button>
                                ...
                                >
                                    <div class="w-8 h-8 bg-[var(--ui-primary)]/10 rounded-lg flex items-center justify-center">
                                        <Icon icon="material-symbols:history" width="16" height="16" class="text-[var(--ui-primary)]" />
                                    </div>
                                    <div class="flex-1 text-left">
                        ...
                        <!-- 기여자 카드 -->
                        <div v-if="contributors?.data && contributors.data.length > 0" class="bg-[var(--ui-bg)] border border-[var(--ui-border)] rounded-xl shadow-sm p-6">
                        ...
                        <div class="bg-[var(--ui-bg)] border border-[var(--ui-border)] rounded-xl shadow-sm p-6">
                            ...
                            <div class="space-y-3 text-sm">
                                ...
                                <div class="flex items-center gap-3">
                                    <div class="w-8 h-8 bg-[var(--ui-primary)]/10 rounded-lg flex items-center justify-center">
                                        <Icon icon="material-symbols:calendar-add-on" width="16" height="16" class="text-[var(--ui-primary)]" />
                                    </div>
                                    <div class="flex-1">
                                        <div class="text-xs font-medium text-[var(--ui-text-muted)] uppercase tracking-wide">생성일</div>
                                ...
                                <div class="flex items-center gap-3">
                                    <div class="w-8 h-8 bg-[var(--ui-primary)]/10 rounded-lg flex items-center justify-center">
                                        <Icon icon="material-symbols:schedule-outline" width="16" height="16" class="text-[var(--ui-primary)]" />
                                    </div>
                                    <div class="flex-1">
                                        <div class="text-xs font-medium text-[var(--ui-text-muted)] uppercase tracking-wide">최근 수정</div>
                                ...
                                <div class="flex items-center gap-3">
                                    <div class="w-8 h-8 bg-[var(--ui-primary)]/10 rounded-lg flex items-center justify-center">
                                        <Icon icon="material-symbols:fingerprint" width="16" height="16" class="text-[var(--ui-primary)]" />
                                    </div>
                                    <div class="flex-1">
                                        <div class="text-xs font-medium text-[var(--ui-text-muted)] uppercase tracking-wide">문서 ID</div>
